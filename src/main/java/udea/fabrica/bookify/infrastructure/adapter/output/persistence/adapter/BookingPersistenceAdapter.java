...
public class BookingPersistenceAdapter implements BookingRepositoryPort {
    ...
    public Booking save(Booking b){ 
        ...
        e.setDisponibilidadId(b.getAvailabilityId()); // <--- ¡ESTO FALTABA!
        e.setFechaReserva(b.getFechaReserva());
        e.setNotas(b.getNotas());
        e.setFechaCreacion(b.getFechaCreacion());
        e.setFechaActualizacion(b.getFechaActualizacion()); 
    ...
    public Optional<Booking> findById(UUID id){ 
        ...
        b.setAvailabilityId(e.getDisponibilidadId()); // <--- ¡Y AQUÍ TAMBIÉN!
    ...
    public Optional<UUID> findAvailabilityIdByBookingId(UUID id){ 
        return em.createQuery("select o.disponibilidadId from OcupacionDisponibilidadEntity o where o.reservaId=:id", UUID.class)
                .setParameter("id", id)
                .getResultStream()
                .findFirst(); 
    }
    ...
    public void deleteOccupation(UUID a, UUID b){
        em.createQuery("delete from OcupacionDisponibilidadEntity o where o.disponibilidadId=:a and o.reservaId=:b")
          .setParameter("a", a)
          .setParameter("b", b)
          .executeUpdate();
    }
